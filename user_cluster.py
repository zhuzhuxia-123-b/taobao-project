...
base_path = "data_process/processed/taobao/"
os.makedirs(base_path, exist_ok=True)

print("⏳ 读取 chained.csv...")
df = pd.read_csv(base_path + "chained.csv")
...
user_feature.to_pickle(base_path + "user_groups.pkl")
user_feature.to_csv(base_path + "user_groups.csv", index=False, encoding="utf-8-sig")
print("✅ user_cluster 完成")
print(f"📊 各群体用户数：")
